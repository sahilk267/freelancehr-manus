...
import { canAccessWorkspacePath, requestedWorkspaceId, resolveWorkspaceAccess } from "../services/workspaceAccess";
...
const requireUser = t.middleware(async opts => {
  ...
  if (actor.role !== "admin" && workspace.isOwner && !selfServicePath) {
